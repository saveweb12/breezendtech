              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  <div className="row align-items-center">
                    <div className="footer_logo">
                      ...
                      <p>
                        Breeze End Technology offers a wide range of IT services
                        by implementing the latest technological developments.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  <div className="top text-center">
                    ...
                    <p>
                      {" "}
                      6383 Little River Turnpike Alexandria, VA 22312, United
                      States{" "}
                    </p>
                    <span className="contact_link">
                      <a href="#" className="read_more type_two">
                        Contact Us <span className="icon-arrow-right" />
                      </a>
                      <a href="#" className="read_more type_two">
                        Breezendtech Gives Back{" "}
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  <div className="row">
                    <div className="text-right bottom">
                      ...
                      <div className="con_content text-right">
                        <h6> Phone :</h6>
                        <a href="tel:+7037127808"> +1 (703) 712-7808</a>
                      </div>
                      <div className="con_content text-right">
                        <h6> Mail Us :</h6>
                        <a href="tel:info@breezendtechs.com">
                          {" "}
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12 col-sm-12">
                <div className="footer_copy_content">
                  Copyright ©️ 2024 Breeze End Technology, LLC.
                </div>
              </div>
              <div className="col-lg-6 col-md-12 col-sm-12">
            ...
            <div className="row">
              <div className="col-lg-5 col-md-12 form_inner">
                <div className="form_content">
                  <form
                    ...
                    method="post"
                    action="https://breezendtechs.com/html/creote-html/sendemail.php"
                  >
                    <p>
                      <label>
                        {" "}
              ...
              <div className="col-lg-7 col-md-12 about_company_inner">
                <div className="abt_content">
                  ...
                  <div className="text">
                    <p>
                      Breeze End Technology provides the highest level of IT
                      Support services to our clients within the United States
                      and the rest of the world. From Web Design &amp;
                      Development, to Repair Services, Cybersecurity Services,
                      to IT network solutions, Data Services, to IT Solutions,
                      Cloud Solutions, to Digital Marketing Services, we do it
                      all.
                    </p>
                    <p>
                      We are a leading System Integrator Company based in
                      Northern America. We believe that our role as a System
                      Integrator is to provide quality service and consultation
                      for IT design, repairs, software, and infrastructure
                      investment without compromising security and business
                      needs. We have successfully established our repute in the
                      regional market for some years now.
                    </p>
                    <a href="#">Read More</a>
                  </div>
