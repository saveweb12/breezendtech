...
import Finduoutour from "../../components/index/FindOutOur";
import Seoservices from "../../components/index/Seoservices";
...
const index = () => {
    ...
    useEffect(() => {
        ...
        ScrollTrigger.create({
            ...
            onEnter: () => gsap.set(heading, {
                position: 'fixed',
                // top: '50%',
                transform: 'translate(10% ,-50%)',
                zIndex: 3000
            }),
            onLeave: () => gsap.set(heading, {
                position: 'relative',
                top: 'unset',
                transform: 'none'
            }),
            onEnterBack: () => gsap.set(heading, {
                position: 'fixed',
                // top: '50%',
                transform: 'translate(10% ,-50%)',
                zIndex: 3000
            }),
            onLeaveBack: () => gsap.set(heading, {
                position: 'relative',
                top: 'unset',
                transform: 'none'
            }),
