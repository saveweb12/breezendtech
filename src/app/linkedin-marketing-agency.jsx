        ...
        <div className="row">
          <div className="col-md-12">
            <div className="banner_title_inner">
              <div className="title_page">LinkedIn Marketing Agency</div>
              <p className="service-text">LinkedIn Marketing Agency services</p>
            </div>
          ...
          <div className="col-lg-12">
            <div className="breadcrumbs creote">
              <ul className="breadcrumb m-auto">
                ...
                <li className="active">LinkedIn Marketing Agency</li>
              </ul>
            </div>
          </div>
        </div>
...
export default linkedinmarketingagency