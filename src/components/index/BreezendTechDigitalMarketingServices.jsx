...
const BreezendTechDigitalMarketingServices = ({data}) => {
  return (
   <>
   {data.map((items)=>(
     ...
     <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12 border-right">
       <div className="process_box style_one dark_color">
         <div className="process_box_outer">
           <div className="icon">
             <Image
               src="/images/icons/custom-website-design.png"
               className="img-fluid svg_image"
               alt="icon png"
             />
           </div>
     ...
     <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12 border-right">
       <div className="process_box style_one dark_color">
         <div className="process_box_outer">
           <div className="icon">
             <Image
               src="/images/icons/social-media-marketing2.png"
               className="img-fluid svg_image"
               alt="icon png"
             />
           </div>
     ...
     <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12 border-right">
       <div className="process_box style_one dark_color">
         <div className="process_box_outer">
           ...
           <div className="content_box">
             <h6>
               <a href="#">Amazon Marketing Services (AMS)</a>
             </h6>
             <p>
               It is a long established fact that a reader will be distracted
               by the readable content of a page when looking at its layout.
     ...
     <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12 border-right">
       <div className="process_box style_one dark_color">
         <div className="process_box_outer">
           <div className="icon">
             <Image
               src="/images/icons/ecommerce-web-design.png"
               className="img-fluid svg_image"
               alt="icon png"
             />
           </div>
     ...
     <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
       <div className="process_box style_one dark_color">
         <div className="process_box_outer">
           <div className="icon">
             <Image
               src="/images/icons/web-hosting.png"
               className="img-fluid svg_image"
               alt="icon png"
             />
           </div>
...
export default BreezendTechDigitalMarketingServices