...
const MarketingBrandingStrategy = () => {
  return (
   <>
   <section>
    {/*===============spacing==============*/}
          ...
          <div className="service_box style_two dark_color">
            <div className="image_boxes style_four">
              <div className="image one">
                <img
                  src="/images/service/marketing-branding.jpg"
                  className="img-fluid"
                  alt="about"
                />
              </div>
        ...
        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
          <div className="title_all_box style_three  dark_color">
            <div className="title_sections three left">
              <div className="before_title">Branding</div>
...
export default MarketingBrandingStrategy